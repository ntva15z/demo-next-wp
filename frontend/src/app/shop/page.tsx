...
const filterSections = [
  {
    ...
    options: [
      ...
      { id: 'zara', label: 'Zara', count: 150 },
      { id: 'hm', label: 'H&M', count: 320 },
    ],
    expanded: true,
  },
  {
    ...
    options: [
      ...
      { id: '2000-2500', label: 'Rs. 2000 to Rs. 2500', count: 206 },
      { id: 'above-2500', label: 'Rs. 2500 to Rs. 3000', count: 7596 },
    ],
    expanded: true,
  },
  {
    ...
    options: [
      ...
      { id: 'green', label: 'Green', count: 100 },
      { id: 'yellow', label: 'Yellow', count: 100 },
    ],
    expanded: true,
  },
  {
    ...
    options: [
      ...
      { id: '50-above', label: '50% and above', count: 82 },
      { id: '60-above', label: '60% and above', count: 69 },
    ],
    expanded: true,
  },
];
...
// Mock products data
const mockProducts: ShopProduct[] = Array.from({ length: 16 }, (_, i) => ({
  id: `product-${i + 1}`,
  name: 'Womens Denim Jacket',
  slug: `womens-denim-jacket-${i + 1}`,
  brand: 'Brand Name',
  price: 700,
  originalPrice: 1000,
  discount: 30,
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Women&apos;s Clothing</h1>
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-center mt-12">
              <nav className="flex items-center gap-2">
                ...
                <button className="w-10 h-10 text-sm text-gray-700 hover:bg-gray-100 rounded-lg">
                  20
                </button>
